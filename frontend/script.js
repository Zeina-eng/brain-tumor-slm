document.addEventListener('DOMContentLoaded', () => {
    // API Configurations
    // Update API_URL to match your backend port or deployed URL.
    const isDeployed = window.location.hostname !== 'localhost' && window.location.hostname !== '127.0.0.1';
    const API_URL = isDeployed
        ? 'https://brain-tumor-slm-backend.onrender.com/summarize' // Verify this matches your deployed Render URL
        : 'http://127.0.0.1:10000/summarize';
